...
import RapidLIne from "../../components/echarts/RapidLIne";
...
const DashboardOperationalSnapshot = () => {
        ...
        <Grid xs={12} sm={12} md={6} lg={4} xl={4}>
          ...
          >
            ...
            <div className="!z-10" style={{ background: "linear-gradient(180deg, rgba(72, 49, 157, 0.20) 0%, rgba(72, 49, 157, 0.00) 100%)" }}>
              ...
              <div className="px-8 xxs:px-16 py-[40px] ">
...
export default DashboardOperationalSnapshot
